...
import { P4UNavigationItem, FuseNavigationService, FuseVerticalNavigationComponent } from '@fuse/components/navigation';
...
export class NavigationComponent
{
     ...
     */
    getNavItem(itemId, navigationName): P4UNavigationItem | null
    {
    ...
    swapNavigationData(navigationName): void
    {
        ...
        const newNavigation: P4UNavigationItem[] = [
            {
