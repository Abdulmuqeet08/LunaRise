            ...
            changes    : [
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(apps/contacts) Added confirmation to the "Delete contact" action using TRAConfirmationService',
                        '(apps/ecommerce/inventory) Added confirmation to the "Delete product" action using TRAConfirmationService',
                        '(apps/scrumboard) Added confirmation to the "Delete list" action using TRAConfirmationService',
                        '(apps/tasks) Added confirmation to the "Delete task" action using TRAConfirmationService',
                        '(ui/confirmation-dialog) Created a separate page for TRAConfirmationService and put the example configurator in there for better visibility',
