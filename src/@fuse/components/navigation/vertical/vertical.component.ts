...
import { P4UNavigationItem, FuseVerticalNavigationAppearance, FuseVerticalNavigationMode, FuseVerticalNavigationPosition } from '@fuse/components/navigation/navigation.types';
...
export class FuseVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
    ...
    @Input() name: string = this._P4UUtilsService.randomId();
    @Input() navigation: P4UNavigationItem[];
    ...
    onCollapsableItemCollapsed: ReplaySubject<P4UNavigationItem> = new ReplaySubject<P4UNavigationItem>(1);
    onCollapsableItemExpanded: ReplaySubject<P4UNavigationItem> = new ReplaySubject<P4UNavigationItem>(1);
    ...
    constructor(
        ...
        private _P4UUtilsService: P4UUtilsService
    )
    {
    ...
    ngOnInit(): void
    {
        ...
        if ( this.name === '' )
        {
            this.name = this._P4UUtilsService.randomId();
        }
     ...
     * @param item
     */
    openAside(item: P4UNavigationItem): void
    {
     ...
     * @param item
     */
    toggleAside(item: P4UNavigationItem): void
    {
        // Toggle
