...
import { P4UAlertAppearance, P4UAlertType } from '@fuse/components/alert/alert.types';
import { P4UAlertService } from '@fuse/components/alert/alert.service';
...
export class P4UAlertComponent implements OnChanges, OnInit, OnDestroy
{
    ...
    @Input() appearance: P4UAlertAppearance = 'soft';
    @Input() dismissed: boolean = false;
    @Input() dismissible: boolean = false;
    @Input() name: string = this._P4UUtilsService.randomId();
    @Input() showIcon: boolean = true;
    @Input() type: P4UAlertType = 'primary';
    ...
    constructor(
        ...
        private _P4uAlertService: P4UAlertService,
    ...
    ngOnInit(): void
    {
        ...
        this._P4uAlertService.onDismiss
            .pipe(
