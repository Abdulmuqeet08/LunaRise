...
import { FuseApiReplyCallback } from '@fuse/lib/api/api.types';

export class P4UApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: FuseApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: FuseApiReplyCallback): void
    {
        // Store the reply
