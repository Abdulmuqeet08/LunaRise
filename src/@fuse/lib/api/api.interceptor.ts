...
import { P4UApiService } from '@fuse/lib/api/api.service';

@Injectable({
    providedIn: 'root'
})
export class FuseApiInterceptor implements HttpInterceptor
{
    /**
     * Constructor
     */
    constructor(
        ...
        private _P4UApiService: P4UApiService
    )
    {
    }
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>>
    {
        ...
        const {
                  handler,
                  urlParams
              } = this._P4UApiService.findHandler(request.method.toUpperCase(), request.url);
